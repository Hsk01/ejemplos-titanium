...
static NSString * const kClase3Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_clase3Injection
{
	...
	[html appendString:kClase3Javascript];
...
{
	// attempt to make well-formed HTML and inject in our Clase3 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _clase3Injection]];
