 ...
 * Copyright (c) 2009-2011 by Clase3, Inc. All Rights Reserved.
...
//@interface Clase3Object : NSObject
//@end

@interface Clase3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Clase3Object class]])
		{
			for (NSString *key in [[(Clase3Object*)o modules] allKeys])
			{
