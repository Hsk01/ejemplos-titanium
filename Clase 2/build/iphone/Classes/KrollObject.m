 ...
 * Copyright (c) 2009-2011 by Clase2, Inc. All Rights Reserved.
...
//@interface Clase2Object : NSObject
//@end

@interface Clase2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Clase2Object class]])
		{
			for (NSString *key in [[(Clase2Object*)o modules] allKeys])
			{
