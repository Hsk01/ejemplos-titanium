...
/**
 The base class for all Clase2 modules
 */
...
/**
 Clase2 Platform calls this method on startup.
 */
-(void)startup;

/**
 Clase2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Clase2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Clase2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Clase2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
