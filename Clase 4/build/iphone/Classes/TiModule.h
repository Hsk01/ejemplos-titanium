...
/**
 The base class for all Clase4 modules
 */
...
/**
 Clase4 Platform calls this method on startup.
 */
-(void)startup;

/**
 Clase4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Clase4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Clase4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Clase4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
