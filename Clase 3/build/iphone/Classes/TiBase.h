...
// in simulator we redefine to format for Clase3 Developer console
...
{\
	NSString * exceptionName = [@"org.clase3." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.clase3";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIClase3NativeItemNone = -1, 
	UIClase3NativeItemSpinner = -2,
	UIClase3NativeItemProgressBar = -3,
	
	UIClase3NativeItemSlider = -4,
	UIClase3NativeItemSwitch = -5,
	UIClase3NativeItemMultiButton = -6,
	UIClase3NativeItemSegmented = -7,
	
	UIClase3NativeItemTextView = -8,
	UIClase3NativeItemTextField = -9,
	UIClase3NativeItemSearchBar = -10,
	
	UIClase3NativeItemPicker = -11,
	UIClase3NativeItemDatePicker = -12,
	
	UIClase3NativeItemInfoLight = -13,
	UIClase3NativeItemInfoDark = -14,
	
	UIClase3NativeItemDisclosure = -15,
	
	UIClase3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Clase3 instances of
