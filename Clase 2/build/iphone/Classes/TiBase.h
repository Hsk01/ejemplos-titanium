...
// in simulator we redefine to format for Clase2 Developer console
...
{\
	NSString * exceptionName = [@"org.clase2." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.clase2";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIClase2NativeItemNone = -1, 
	UIClase2NativeItemSpinner = -2,
	UIClase2NativeItemProgressBar = -3,
	
	UIClase2NativeItemSlider = -4,
	UIClase2NativeItemSwitch = -5,
	UIClase2NativeItemMultiButton = -6,
	UIClase2NativeItemSegmented = -7,
	
	UIClase2NativeItemTextView = -8,
	UIClase2NativeItemTextField = -9,
	UIClase2NativeItemSearchBar = -10,
	
	UIClase2NativeItemPicker = -11,
	UIClase2NativeItemDatePicker = -12,
	
	UIClase2NativeItemInfoLight = -13,
	UIClase2NativeItemInfoDark = -14,
	
	UIClase2NativeItemDisclosure = -15,
	
	UIClase2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Clase2 instances of
