...
// in simulator we redefine to format for Clase4 Developer console
...
{\
	NSString * exceptionName = [@"org.clase4." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.clase4";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIClase4NativeItemNone = -1, 
	UIClase4NativeItemSpinner = -2,
	UIClase4NativeItemProgressBar = -3,
	
	UIClase4NativeItemSlider = -4,
	UIClase4NativeItemSwitch = -5,
	UIClase4NativeItemMultiButton = -6,
	UIClase4NativeItemSegmented = -7,
	
	UIClase4NativeItemTextView = -8,
	UIClase4NativeItemTextField = -9,
	UIClase4NativeItemSearchBar = -10,
	
	UIClase4NativeItemPicker = -11,
	UIClase4NativeItemDatePicker = -12,
	
	UIClase4NativeItemInfoLight = -13,
	UIClase4NativeItemInfoDark = -14,
	
	UIClase4NativeItemDisclosure = -15,
	
	UIClase4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Clase4 instances of
