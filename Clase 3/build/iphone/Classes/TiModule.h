...
/**
 The base class for all Clase3 modules
 */
...
/**
 Clase3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Clase3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Clase3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Clase3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Clase3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
