 ...
 * Copyright (c) 2009-2011 by Clase4, Inc. All Rights Reserved.
...
//@interface Clase4Object : NSObject
//@end

@interface Clase4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Clase4Object class]])
		{
			for (NSString *key in [[(Clase4Object*)o modules] allKeys])
			{
